...
import { AnswerDoc, CommentDoc, UserPrefs, VoteDoc } from "@/types";
                ...
                <div className="flex gap-4">
                    <div className="flex shrink-0 flex-col items-center gap-4">
                        <VoteButtons
                            ...
                            id={question.$id}
                            className="w-full"
                            upvotes={VoteButtons as unknown as Models.DocumentList<VoteDoc>}
                            downvotes={VoteButtons as unknown as Models.DocumentList<VoteDoc>}
                        />
                        <EditQuestion
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <picture>
                            <img
                                src={(storage.getFilePreview(questionAttachmentBucket, question.attachmentId) as unknown as { href: string }).href}
                                alt={question.title}
                        ...
                        <Comments
                            comments={comments as unknown as Models.DocumentList<CommentDoc>}
                            className="mt-4"
                            type="question"
                            typeId={question.$id}
                        />
